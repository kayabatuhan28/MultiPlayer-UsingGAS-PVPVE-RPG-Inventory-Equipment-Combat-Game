...
#include "InventorySystem/InventoryManagement/FastArray/Inv_FastArray.h"
...
class TPGAS_API UInv_InventoryComponent : public UActorComponent
{
	GENERATED_BODY()
...
private:
	...
	// Droplanan itemin yere ne kadar yakin olacagini belirler
	UPROPERTY(EditAnywhere, Category = "Inventory")
