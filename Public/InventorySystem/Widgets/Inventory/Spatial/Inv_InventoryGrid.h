...
UCLASS()
class TPGAS_API UInv_InventoryGrid : public UUserWidget
{
	GENERATED_BODY()
...
private:
	...
	void AddItemAddIndex(UInv_InventoryItem* Item, const int32 Index, const bool bStackable, const int32 StackAmount);
