...
void UInv_Leaf_LabeledValue::SetText_Label(const FText& Text, bool Collapse) const
{
	if (Collapse)
	{
...
void UInv_Leaf_LabeledValue::SetText_Value(const FText& Text, bool Collapse) const
{
	if (Collapse)
	{
